    ...
    <Stack spacing={1.75}>
      <Stack direction={{ xs: "column", md: "row" }} spacing={1} justifyContent="space-between" alignItems={{ xs: "flex-start", md: "center" }}>
        <Stack direction="row" spacing={0.5} alignItems="center">
          ...
          <Typography variant="body2" color="text.secondary" fontWeight={700}>{selectedCount} / 4</Typography>
          <HelpTooltip title={t("weather.comparison.description")} label={t("weather.comparison.help_label")} />
        </Stack>
      ...
      {selectedCount < 2 && <Typography variant="caption" color="text.secondary">{t("weather.comparison.select_more")}</Typography>}
